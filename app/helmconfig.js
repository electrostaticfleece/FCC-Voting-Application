...
//TODO: Determine fonts, build stylesheet, determine favIcons
...
const config = {
  ...
  meta: [
    ...
    { name: 'description', content: 'An voting applicaion built with React, Express and PostgreSQL deployable to Heroku' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Collision' },
